  ...
  <div class="chooseus">
    ...
    <div class="card-wrapper">
      <div class="card">
        <div class="card-img">
          <div  class="card-bg">
            <img src="../assets/images/prize.png" class="service-icons"/>
          </div>
        </div>
        <h4 class="card-title">
      ...
      <div class="card">
        <div class="card-img">
          <div  class="card-bg">
            <img src="../assets/images/think.png" class="service-icons"/>
          </div>
        </div>
        <h4 class="card-title">
          WE ARE INNOVATORS
      ...
      <div class="card">
        <div class="card-img">
          <div  class="card-bg">
              <img src="../assets/images/ip.png" class="service-icons"/>
          </div>
        </div>
        <h4 class="card-title">
          WE OWN OUR IP
      ...
      <div class="card">
        <div class="card-img">
          <div  class="card-bg">
            <img src="../assets/images/box.png" class="service-icons"/>
          </div>
        </div>
        <h4 class="card-title">
...
.card-img{
  width: 150px;
  height: 150px;
  background: linear-gradient(to bottom, var(--navblue), var(--darkerblue), var(--darkblue));
  border-radius: 50%;
  display: flex;
  align-items: center;
  justify-content: center;
