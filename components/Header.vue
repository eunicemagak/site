    ...
    <div class="nav-wrapper">
      ...
      <div class="navigation">
        ...
        <div class="nav-links">
          ...
          <nuxt-link to="/OurStory" class="nav-link"> OUR STORY </nuxt-link>
          <div class="dropdown">
            <div
